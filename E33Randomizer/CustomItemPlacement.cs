...
public class CustomItemPlacement: CustomPlacement
{
    ...
    public override void InitPlainNames()
    {
        ...
        {
            "Pictos", "Invalid", "Weapon", "Inventory", "Key", "Skill Unlock", "Cosmetic", "Upgrade Material", "Consumable", "Foot", "Merchant Unlock", "Journal", "Music Record", "Cut Content", "Anything"
        };
