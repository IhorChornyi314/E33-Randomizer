...
public class CustomSkillPlacement: CustomPlacementWindowViewModel
{
    ...
    public override void LoadDefaultPreset()
    {
        ...
        {
            { "Gustave's Skills", [new KeyValuePair<string, byte>("Gustave's Skills", 1)] },
            { "Lune's Gradient Skills", [new KeyValuePair<string, byte>("Lune's Gradient Skills", 1)] },
            { "Lune's Non-gradient Skills", [new KeyValuePair<string, byte>("Lune's Non-gradient Skills", 1)] },
            { "Maelle's Gradient Skills", [new KeyValuePair<string, byte>("Maelle's Gradient Skills", 1)] },
            { "Maelle's Non-gradient Skills", [new KeyValuePair<string, byte>("Maelle's Non-gradient Skills", 1)] },
            { "Monoco's Gradient Skills", [new KeyValuePair<string, byte>("Monoco's Gradient Skills", 1)] },
            { "Monoco's Non-gradient Skills", [new KeyValuePair<string, byte>("Monoco's Non-gradient Skills", 1)] },
            { "Verso's Gradient Skills", [new KeyValuePair<string, byte>("Verso's Gradient Skills", 1)] },
            { "Verso's Non-gradient Skills", [new KeyValuePair<string, byte>("Verso's Non-gradient Skills", 1)] },
            { "Sciel's Gradient Skills", [new KeyValuePair<string, byte>("Sciel's Gradient Skills", 1)] },
            { "Sciel's Non-gradient Skills", [new KeyValuePair<string, byte>("Sciel's Non-gradient Skills", 1)] }
        });
